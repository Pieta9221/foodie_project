...
if(isset($_POST['submit'])){
  ...
  if($pword != $pword1){
    ...
    $error = "Ooops! Old password is incorrect!";
    
  }elseif($pword == $pword2){
    
    $error = "Old and new password should not be same!";
    
  }else{      
    $edit = "UPDATE admindata SET pword ='$pword2'WHERE email='$email'";
  ...
  if($config->query($edit) === TRUE ){
    ...
    $error = "Ooops! Password not updated!";
	...
	<div class="contact-from-section mt-150 mb-150">
        ...
        <div class="col-lg-8 mb-5 mb-lg-0">
					...
					<div class="add-form">
						<form method="POST" >
							<p>
								<input type="password"  placeholder="Enter Old Password" name="pword1" required/>
								
							</p>
							<p>
								<input type="password"  placeholder="Enter New Password" name="pword2" required/>
								
							</p>
							
							</p>
             
							<p><input type="submit" name="submit" value="Edit Password"></p>
