                ...
                <div class="col-md-12">
                    <div class="product-filters">
                        <ul>
                            ...
                            <li data-filter=".strawberry">Rice</li>
                            <li data-filter=".berry">Soup</li>
                            <li data-filter=".lemon">Others</li>
                        </ul>
                    </div>
                </div>
            </div>
			...
			<div class="row product-lists">
				...
				<div class="col-lg-4 col-md-6 text-center berry">
					<div class="single-product-item">
						...
						<h3>Oha Soup</h3>
						<p class="product-price"><span>Per Serving</span> &#8358;1,300 </p>
						<a href="cart.html" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 text-center lemon">
					<div class="single-product-item">
						...
						<p class="product-price"><span>Per Serving</span> &#8358;1,000 </p>
						<a href="cart.html" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 text-center strawberry">
					<div class="single-product-item">
						...
						<h3>Jollof Rice</h3>
						<p class="product-price"><span>Per Serving</span> &#8358;1,800 </p>
						<a href="cart.html" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 text-center berry">
					<div class="single-product-item">
						...
						<h3>Afang Soup</h3>
						<p class="product-price"><span>Per Serving</span> &#8358;1,600 </p>
						<a href="cart.html" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
					</div>
				</div>
