...
if(isset($_POST['fund'])){
   ...
   $edit = "UPDATE users SET wallet='$wallet3' WHERE email='$email'";
    
    if($config->query($edit)===TRUE){
      
      $success = "Wallet successfully funded";
      header("location:wallet.php");
    } else{
      $error = "Ooops! Problem with funding wallet";
    }
      }
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="breadcrumb-text">
						<p>fund wallet with your card</p>
						<h1>Fund Wallet</h1>
					</div>
				</div>
			</div>
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="row">
                            <div class="col-md-12 pad-adjust">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" checked class="text-muted" required=""> Save details for fast payments. <a href="#" class="link">Learn More</a>
                                    </label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-3">
                                <input type="number" name="wallet2" class="form-control" placeholder="1000" required="" />
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-6 pad-adjust">
                              <input type="submit" name = "fund" class="cart-btn btn-success btn-block" value="Fund" required="" />
                            </div>
                             </form>
                        </div>
